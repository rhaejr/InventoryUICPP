...
{
    ui->setupUi(this);
	QPushButton* search = ui->search_button;
	QObject::connect(search, SIGNAL(clicked()), this, SLOT(test()));
	//connect(search, SIGNAL(clicked), this, MainWindow::test);
}
